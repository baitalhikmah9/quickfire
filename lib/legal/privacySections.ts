...
export const PRIVACY_SECTIONS: LegalSection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Gameplay and product usage: We process information about how you use Backfire, including game configuration, match and session records, scores and events, the topics locked in when a match board starts (for product analytics such as topic popularity), category and language preferences, and related metadata needed to run matches and show history.',
  ...
  },
  {
    ...
    paragraphs: [
      'We use the information above to provide, maintain, and improve the Service; authenticate users; operate gameplay, leaderboards, and stats as designed; understand which topics players choose so we can improve question packs; manage tokens, wallets, and promo codes; detect abuse and fraud; comply with law; and communicate with you about the Service where appropriate.',
    ],
  },
  {
