...
# Codebase Map — QuickFire

> Auto-generated by Cartographer. Last mapped: 2026-04-11

## System Overview

QuickFire is a competitive multiplayer trivia mobile app built with **Expo SDK 55** (React Native 0.83, React 19.2). Uses Expo Router for navigation, **Clerk** for auth, **Convex** for backend/data, **Zustand** for ephemeral UI state, and TypeScript throughout.
...
│   ├── quickfire-full-product-plan.md
│   ├── prd.txt
│   ├── modals.md
│   └── native-tabs.md
│
